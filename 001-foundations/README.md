...
| 코드 | 디렉터리 | 역할 |
|---:|---|---|
| 010 | [`010-overview`](./010-overview/) | 시험 구조·Domain·7일 계획 |
| 020 | [`020-terms`](./020-terms/) | 필수 용어·약어 |
...
| Day | 핵심 목표 |
|---:|---|
| 1 | Git / GitHub / Version Control / Repository |
| 2 | Commit / Branch / Merge / GitHub Flow |
