# 010 Question Bank Index — 6개 자격증 문제은행
...
장기 역량 학습은 `001 → 002 → 003 → 004 → 005 → 006`, 단기 자격 취득 Fast Track은 `001 → 003 → 002 → 004 → 005 → 006` 순으로 사용합니다.

## 점수 기록 (Score Record, SR)

| 코드 | 1회차 | 2회차 | Retry | QBank Gate |
|---:|---:|---:|---:|---|
| 001 | - | - | - | NOT STARTED |
| 002 | - | - | - | NOT STARTED |
| 003 | - | - | - | NOT STARTED |
...
> 실제 학습 점수는 각 과정의 `130-progress/`에도 함께 기록합니다.
