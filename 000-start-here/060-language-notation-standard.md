...
GitHub 제품명·자격증명·시험 코드처럼 공식 영어 명칭이 중요한 경우에도 한국어 설명을 먼저 제공합니다. 단, 공식 명칭 자체를 임의로 변경한 것처럼 보이지 않도록 괄호 안에 원문을 유지합니다.
...
1. 제목과 주요 섹션은 가능한 한 `한글 (English, ABBR)` 형식을 사용합니다.
2. 약어는 첫 등장 시 반드시 풀어서 설명합니다.
3. 공식 약어와 GCLS 내부 약어를 혼동하지 않습니다.
4. 명령어·코드·경로를 번역하지 않습니다.
